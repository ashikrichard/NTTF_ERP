...
<meta name="keywords" content="NTTF web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> NTTF</a></h1>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>we bring learning to people instead of bringing people to learning.</p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Skilled Trainer</h5>
				<p>minimizing gap between demand and supply of skilled manpowerof nation.</p>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>library is a curated collection of source of information and similar resource.</p>
			</div> 
			<div class="clearfix"> </div>
		</div>  
	</div>
...
<section
 class="portfolio-w3ls" id="gallery">
		...
		<div class="w3layouts_header">
			...
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g1.jpg" class
					="swipebox"><img src="images/g1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>NTTF</h4>
...
<div class="team-w3l" id="team">
	<div class="container">
		<h3 class="w3l-title">Our Skilled Trainer</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com"><br>enquiry@nttf.co.in</a>
						</p>
				</div>
				<div class="clearfix"> </div>
			</div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>About Us</h4>
				<p>Secure your future with your own hands</p>
			</div>
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>Navigation</h4>
				<ul>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:enquiry@nttf.co.in">enquiry@nttf.co.in</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>1800 103 6883</li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!--<div class="w3layouts_copy_right">
	<div class="container">
		<p>© 2017 NTTF. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a></p>
	</div>
</div>-->
<!-- //footer -->
